    ...
    <div class="bg-white shadow-lg rounded-xl p-6 w-full max-w-md text-center">
        @if ($translation)
            ...
            <div class="mb-4">
                ...
                <p class="text-blue-600 font-medium">{{ $translation->lang }}</p>
            </div>
            ...
            <div class="flex justify-between mt-6">
                <button wire:click="markAsCorrect({{ $translation->translation_id }})"
                    class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg shadow">
                    Done
                </button>
                <button wire:click="skip({{ $translation->translation_id }})"
